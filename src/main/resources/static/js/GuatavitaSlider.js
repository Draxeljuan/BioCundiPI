document.addEventListener('DOMContentLoaded', () => {
    ...
    const plantSearchTerms = ['Crataegus', 'Guadua de castilla', 'Oreopanax floribundum', 'Macleania rupestris', 'Cacao sabanero', 'Clusia multiflora', 'Baccharis bogotensis'];
    const faunaSearchTerms = ['Tree Ocelot', 'Odocoileus virginianus', 'Vultur ', 'Lepidopyga lilliae', 'Megaceryle torquata', 'Sciurus granatensis', 'Atractus crassicaudatus', 'Hyalinobatrachium esmeralda', 'Piaya cayana', 'Waldfuchs']; // Especies
