document.addEventListener('DOMContentLoaded', () => {
    ...
    const plantSearchTerms = ['Weinmannia', 'frailejon', 'Ceroxylon vogelianum', 'Centronia mutisii', 'Cestrum buxifolium', 'Pittosporum', 'Piper bogotense'];
    const faunaSearchTerms = ['Odocoileus', 'majkong', 'Oryctolagus cuniculus', 'Cavia aperea Erxleben', 'Anisognathus', 'Heliangelus exortis', 'Anas discors', 'Pristimantis bogotensis']; // Especies
