document.addEventListener('DOMContentLoaded', () => {
    ...
    const plantSearchTerms = ['Espeletia Mutis', 'Espeletia argentea', 'Weinmannia', 'Chusquea tessellata', 'Escallonia', 'Lupinus colombiensis', 'Bejaria resinosa'];
    const faunaSearchTerms = ['Tremarctos ornatus', 'Odocoileus virginianus', 'Onza bermeja', 'Urocyon cinereoargenteus', 'Oryctolagus', 'Vultur', 'Cairina moschata', 'Colibri coruscans']; // Especies
