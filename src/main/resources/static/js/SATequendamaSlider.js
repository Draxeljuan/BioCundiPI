document.addEventListener('DOMContentLoaded', () => {
    ...
    const plantSearchTerms = ['Cecropia peltata', 'Asplenium cristatum', 'Cedrus atlantica', 'Passiflora edulis', 'Cattleya warscewiczii', 'Aechmea fasciata', 'Andesanthus lepidotus'];
    const faunaSearchTerms = ['Cabassous unicinctus', 'Waldfuchs', 'Cavia porcellus', 'Accipiter cooperii', 'Colibrí Verdemar', 'Columbina talpacoti', 'Giaguaro', 'Dendrobates auratus', 'Dynastes hercules', 'Alouatta palliata']; // Especies
